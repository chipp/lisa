...
pub enum DeviceType {
    ...
    Light,
    #[serde(rename = "devices.types.ventilation")]
    Ventilation,
}
...
mod tests {
    ...
    fn test_device_types() {
        ...
        assert_eq!(
            to_value(&DeviceType::Ventilation).unwrap(),
            json!("devices.types.ventilation")
        );
        ...
        assert_eq!(
            from_value::<DeviceType>(json!("devices.types.ventilation")).unwrap(),
